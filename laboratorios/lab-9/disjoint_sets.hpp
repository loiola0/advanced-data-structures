...
public:
  ...
  size_type representative(size_type element){
    ...
    // otherwise, goes recursively in search of a representative
      ...
      size_type aux = representative(representative_[element]);
      representative_[element] = aux;
  ...
  bool join(size_type element_a, size_type element_b){
    ...
    // signaled to the caller
      ...
      if(representative_a != representative_b){
          if (rank[representative_a] ==  rank[representative_b]){
              representative_[representative_b] = representative_a;
              rank[representative_a]++;
              return true;
          }
          ...
          // representative_b
          else if(rank[representative_a] > rank[representative_b]){
              representative_[representative_b] = representative_a;
              return true;
          }else{
